...
-- ==== Begin: 004_webhook_infrastructure.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 004_webhook_infrastructure.sql ====\r\n
-- ==== Begin: 005_message_logs_enhancements.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 005_message_logs_enhancements.sql ====\r\n
-- ==== Begin: 006_add_instagram_username_to_manychat.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 006_add_instagram_username_to_manychat.sql ====\r\n
-- ==== Begin: 007_webhook_idempotency.sql ====\r\nBEGIN;
...
ANALYZE webhook_logs;
\r\nCOMMIT;\r\n-- ==== End: 007_webhook_idempotency.sql ====\r\n
-- ==== Begin: 011_instagram_production_features.sql ====\r\nBEGIN;
-- ===============================================
...
-- Note: Migration tracking is handled automatically by the migration runner
\r\nCOMMIT;\r\n-- ==== End: 011_instagram_production_features.sql ====\r\n
-- ==== Begin: 013_add_utility_messages_tables.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 016_webhook_status_normalization.sql ====\r\n
-- ==== Begin: 017_fix_platform_case_sensitivity.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 018_webhook_events_idempotency.sql ====\r\n
-- ==== Begin: 019_merchant_instagram_mapping_composite_key.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 019a_create_merchant_credentials_minimal.sql ====\r\n
-- ==== Begin: 020_comprehensive_rls_enhancement.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 020_comprehensive_rls_enhancement.sql ====\r\n
-- ==== Begin: 021_conversation_unique_index.sql ====\r\nBEGIN;
...
COMMIT;
\r\nCOMMIT;\r\n-- ==== End: 021_conversation_unique_index.sql ====\r\n
-- ==== Begin: 022_pkce_verifiers_fallback.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 022_pkce_verifiers_fallback.sql ====\r\n
-- ==== Begin: 023_add_business_account_id_to_merchant_credentials.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 023_add_business_account_id_to_merchant_credentials.sql ====\r\n
-- ==== Begin: 024_unique_index_merchant_credentials.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 024_unique_index_merchant_credentials.sql ====\r\n
-- ==== Begin: 025_implement_rls_policies.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 025_implement_rls_policies.sql ====\r\n
-- ==== Begin: 028_add_missing_columns.sql ====\r\nBEGIN;
/**
...
\r\nCOMMIT;\r\n-- ==== End: 028_add_missing_columns.sql ====\r\n
-- ==== Begin: 030_add_missing_tables.sql ====\r\nBEGIN;
/**
...
\r\nCOMMIT;\r\n-- ==== End: 030_add_missing_tables.sql ====\r\n
-- ==== Begin: 036_complete_rls_policies.sql ====\r\nBEGIN;
-- ===============================================
...
ON CONFLICT (migration_name) DO UPDATE SET 
    executed_at = NOW(), 
    status = 'SUCCESS';
\r\nCOMMIT;\r\n-- ==== End: 036_complete_rls_policies.sql ====\r\n
-- ==== Begin: 041_cross_platform_infrastructure.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 041_cross_platform_infrastructure.sql ====\r\n
-- ==== Begin: 042_create_audit_logs.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 053_manychat_integration.sql ====\r\n
-- ==== Begin: 054_production_fixes.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 054_production_fixes.sql ====\r\n
-- ==== Begin: 055_enforce_username_only.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 055_enforce_username_only.sql ====\r\n
-- ==== Begin: 056_manychat_username_and_message_windows.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 056_manychat_username_and_message_windows.sql ====\r\n
-- ==== Begin: 057_currency_and_fx.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 057_currency_and_fx.sql ====\r\n
-- ==== Begin: 058_generic_pricing.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 058_generic_pricing.sql ====\r\n
-- ==== Begin: 059_add_ai_config_to_merchants.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 059_add_ai_config_to_merchants.sql ====\r\n
-- ==== Begin: 060_adjust_audit_logs_for_middleware.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 060_adjust_audit_logs_for_middleware.sql ====\r\n
-- ==== Begin: 061_create_quality_metrics.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 061_create_quality_metrics.sql ====\r\n
-- ==== Begin: 062_enable_rls_minimal.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 062_enable_rls_minimal.sql ====\r\n
-- ==== Begin: 063_message_windows_active_index.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 063_message_windows_active_index.sql ====\r\n
-- ==== Begin: 064_create_job_spool.sql ====\r\nBEGIN;
-- ===============================================
...
BEGIN
  ...
  END IF;
END $$;
\r\nCOMMIT;\r\n-- ==== End: 064_create_job_spool.sql ====\r\n
-- ==== Begin: 065_normalize_platform_case.sql ====\r\nBEGIN;
-- ===============================================
...
COMMIT;
\r\nCOMMIT;\r\n-- ==== End: 065_normalize_platform_case.sql ====\r\n
-- ==== Begin: 066_fix_manychat_unique_conflict.sql ====\r\nBEGIN;
-- ===============================================
...
COMMIT;
\r\nCOMMIT;\r\n-- ==== End: 066_fix_manychat_unique_conflict.sql ====\r\n
-- ==== Begin: 067_add_instagram_business_account_id_to_credentials.sql ====\r\nBEGIN;
-- ===============================================
...
\r\nCOMMIT;\r\n-- ==== End: 067_add_instagram_business_account_id_to_credentials.sql ====\r\n
-- ==== Begin: 068_create_merchant_service_status.sql ====\r\nBEGIN;
-- ===============================================
...
BEGIN
  ...
  END IF;
END $$;
\r\nCOMMIT;\r\n-- ==== End: 068_create_merchant_service_status.sql ====\r\n
-- ==== Begin: 069_create_merchant_kb_docs.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 069_create_merchant_kb_docs.sql ====\r\n
-- ==== Begin: 070_add_source_channel.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 070_add_source_channel.sql ====\r\n
-- ==== Begin: 071_add_merchant_type_and_kb_tags.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 071_add_merchant_type_and_kb_tags.sql ====\r\n
-- ==== Begin: 072_discounts_effective_prices_vaults.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 072_discounts_effective_prices_vaults.sql ====\r\n
-- ==== Begin: 073_seed_ai_config_and_trgm.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 073_seed_ai_config_and_trgm.sql ====\r\n
-- ==== Begin: 074_conversation_rejections.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 074_conversation_rejections.sql ====\r\n
-- ==== Begin: 075_message_image_metadata.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 075_message_image_metadata.sql ====\r\n
-- ==== Begin: 076_customer_memory.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 076_customer_memory.sql ====\r\n
-- ==== Begin: 077_proactive_messaging.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 077_proactive_messaging.sql ====\r\n
-- ==== Begin: 078_prediction_tables.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 078_prediction_tables.sql ====\r\n
-- ==== Begin: 080_instagram_interactions.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 080_instagram_interactions.sql ====\r\n
-- ==== Begin: 081_fix_instagram_order_items_returns.sql ====\r\nBEGIN;
...
\r\nCOMMIT;\r\n-- ==== End: 081_fix_instagram_order_items_returns.sql ====\r\n
-- ==== Begin: 081_fix_predictive_analytics_schema.sql ====\r\nBEGIN;
-- ===============================================
