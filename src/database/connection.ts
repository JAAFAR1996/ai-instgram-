    ...
    try {
      ...
      this.sql = postgres({
        ...
        transform: {
          ...
          undefined: null,
          // Convert JS camelCase to snake_case for database
          column: {
            to: postgres.camel,
            from: postgres.snake
          }
        ...
        onconnect: async (connection) => {
          console.log(`✅ New PostgreSQL connection established (PID: ${connection.processID})`);
        },
        
        onclose: (connection) => {
          console.log(`🔌 PostgreSQL connection closed (PID: ${connection})`);
        }
      });
