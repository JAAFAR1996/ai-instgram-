...
-- Step 10: Test the constraints work with new data
DO $$
BEGIN
    ...
    INSERT INTO webhook_logs (
        ...
        gen_random_uuid(), 'instagram', 'test_event', 'migration-test-017', 'SUCCESS', '{"test": true}', NOW()
    );
    
    -- Clean up test data immediately
    DELETE FROM webhook_logs WHERE event_id = 'migration-test-017';
...
-- Step 12: Update/create the webhook stats view
