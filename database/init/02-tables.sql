-- ===============================================
-- Core Tables for AI Sales Platform
-- ===============================================
...
CREATE TABLE products (
    ...
    -- Product Attributes
    attributes JSONB DEFAULT '{}', -- {color: 'أحمر', size: 'L', weight: '1kg', brand: 'Samsung'}
    variants JSONB DEFAULT '[]', -- [{name: 'Color', values: ['أحمر', 'أزرق']}, {name: 'Size', values: ['S', 'M', 'L']}]
...
CREATE TABLE orders (
    ...
    -- Order Details
    items JSONB NOT NULL, -- [{sku, product_id, name, price, quantity, total, attributes}]
...
CREATE TABLE conversations (
    ...
    platform_thread_id TEXT, -- WhatsApp: from number, Instagram: thread ID
...
-- Message logs table (partitioned by month for performance)
...
-- Message content search trigger
